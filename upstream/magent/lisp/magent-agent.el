...
(defvar magent-agent-sampler-function #'magent-llm-gptel-sample
  "Sampler captured by newly constructed Magent agent loops.

The default preserves the upstream gptel transport.  Runtime integrations may
dynamically bind this to a request-local provider-neutral sampler before
calling `magent-agent-run-turn'.")
                     ...
                     (magent-llm-request-create
                      ...
                      :turn-id (and request-state
                                    (magent-request-context-turn-id
                                     request-state))
                      :sampler magent-agent-sampler-function))
