...
export default defineConfig(({ command }) => ({
  // The website lives under website/. Vite's dev server / build use it
  // as the doc root so index.html resolves correctly. Lib mode (built
  // separately, see src/lib.ts) does NOT share this root.
  root: "website",
