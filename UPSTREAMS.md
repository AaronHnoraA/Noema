# Internalized upstream implementations

Noema carries complete upstream source trees because these interaction and
runtime capabilities are part of the local product implementation. They are
loaded from this repository, not installed as Noema package dependencies.
...
| `upstream/agent-shell/` | `xenodium/agent-shell` | `6a83589393fb67725f288d08d6f12d136564db0e` | structured Emacs agent session UI and event stream |
| `upstream/acp/` | `xenodium/acp.el` | `7d5c16ebcf2af86aa0f14ad9ae0ce45df4e8c8a5` | ACP transport and protocol implementation |
| `upstream/shell-maker/` | `xenodium/shell-maker` | `bb5e3aef17686c1c859c366eb83831b0046dc75a` | comint substrate required by agent-shell |
